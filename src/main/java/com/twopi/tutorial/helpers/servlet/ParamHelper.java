 ...
 * @author arshad01
 * 
 * This class provides a convenient way to read servlet parameters. It also decrypts
 * values for "key" parameters i.e. all parameters whose name ends with ".key".
 *
 */
public class ParamHelper {
	...
	/**
	 * This method is the only publicly accessible method of this class. The value
	 * of the paramName is returned. If "encrypt.keys" property is "1" then the
	 * value of the parameter whose name end in ".key" is first decrypted.
	 * 
